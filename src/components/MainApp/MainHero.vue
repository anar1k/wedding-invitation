...
<template>
  <section class="bg-[url('/bg-hero.jpg')] bg-no-repeat bg-fixed bg-center bg-cover">
    <u-container class="h-[100svh] text-center text-white pt-16 md:pt-20">
      ...
      <h4 class="text-base md:text-xl mt-4">
