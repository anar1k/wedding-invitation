...
const collapseItems: ICollapseItem[] = [
  {
    ...
    text: 'Мы будем рады, если девушки выберут вечерние или коктейльные платья, а мужчины — костюм.',
  },

  {
    title: 'Какие подарки предпочтительны?',
    text: 'Мы будем рады сюрпризам, а также поздравлениям в конвертах.',
  },
