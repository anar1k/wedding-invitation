...
<template>
  <section id="calendar">
    <u-container>
      ...
      >
        <template #header>
          <span class="text-primary font-medium">День свадьбы: {{ new Date(2024, 3, 20).toLocaleDateString() }}</span>
        </template>

        <template #date-cell="{ data }">
          <div class="relative">
            <span :class="data.day.split('-').slice(1)[1] === '20' ? 'text-primary font-medium md:text-xl' : ''">
